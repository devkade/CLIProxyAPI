...
func (s *Server) setupRoutes() {
	...
	v1.Use(AuthMiddleware(s.accessManager), s.clientKeyRateLimitMiddleware())
	{
	...
	openaiV1.Use(AuthMiddleware(s.accessManager), s.clientKeyRateLimitMiddleware())
	{
	...
	codexDirect.Use(AuthMiddleware(s.accessManager), s.clientKeyRateLimitMiddleware())
	{
	...
	v1beta.Use(AuthMiddleware(s.accessManager), s.clientKeyRateLimitMiddleware())
	{
