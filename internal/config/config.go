...
type Config struct {
	...
	// MaxCooldownSeconds caps provider-requested and generated account cooldowns.
	// Values <= 0 use the default cap.
	MaxCooldownSeconds int `yaml:"max-cooldown-seconds" json:"max-cooldown-seconds"`
